            ...
            <SwiperSlide key={index}>
              ...
              <div style={{ width: '100%' }}>
                ...
                <div className="relative w-full h-full ">
                  ...
                  <div className="absolute px-24 w-full flex justify-center items-center h-full justify-items-start text-start  text-white z-10 top-0 left-0 ">
                    <div className="align-middle	">
                      <h2 className="text-xl lg:text-8xl lg:w-3/4 align-middle font-bold ">{item.title}</h2>
