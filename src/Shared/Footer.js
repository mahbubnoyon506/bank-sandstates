...
const Footer = () => {
    ...
    return (
        <div style={{ backgroundImage: `url(${background})` }}>
            <div className=' p-2 md:p-10 lg:p-20'>
                <footer className='md:flex justify-between items-center w-full'>
                    ...
                    <div className='md:flex'>
                        <input type="text" placeholder="Type here" class="input  max-w-xs rounded-full " />
                        <div className='md:ml-[-50px] md:mt-0 mt-2'>
                            <input className='btn btn-primary rounded-full -py-2' type="submit" value="Subscribe" />
                        </div>
                    </div>
                </footer>
            ...
            <footer class="footer  w-full px-10 py-4 bg-black text-white text-center">
